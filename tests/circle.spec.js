...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  it('Verifica se ao receber diferente de um número, a função `circle` retorna undefined', () => {
    expect(circle('')).toBeUndefined();
  });
  it('Verifica se ao receber um raio, a função `circle` retorna um objeto', () => {
    expect(typeof circle(1)).toBe('object');
  });
  it('Verifica se ao receber um raio, a função `circle` retorna um objeto contendo 3 propriedades', () => {
    expect(Object.keys(circle(5))).toHaveLength(3);
  });
  it('Verifica se ao não receber parametro, a função `circle` retorna undefined', () => {
    expect(circle()).toBeUndefined();
  });
  it('Verifica se função retorna uma `key` com `value` igual à circunferência correta para um círculo de raio 2.', () => {
    expect(Object.values(circle(2))).toContain(12.56);
  });
  it('Verifica se função retorna uma `key` com `value` igual à área correta para um círculo de raio 3.', () => {
    expect(Object.values(circle(3))).toContain(28.259999999999998);
  });
  it('Verifica se função retorna um objeto com os dados corretos para um círculo de raio 3.', () => {
